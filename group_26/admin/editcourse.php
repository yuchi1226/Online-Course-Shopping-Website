...
$sql = "UPDATE course SET name = '" . $name . "', subject='". $subject . "', grade='" . $grade . "', smt='". $smt . "', teacher='". $teacher . "', length='". $length. "', total='". $total. "', price='". $price . "', sold='" . $sold . "', valid='" . $valid . "', description='" . $description . "' WHERE id = '". $id . "'";
