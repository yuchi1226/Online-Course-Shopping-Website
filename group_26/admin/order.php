...
<head>
    ...
    $(function() {
      tbl = $('#order').DataTable({
        ...
        "ajax": {
          url: "datatable5_ajax.php",
          data: function(d) {
            return $('#form5').serialize() + "&oper=query";
          },
          type: 'POST',
          dataType: 'json'
        },
      ...
      $('tbody').on('click', '#btn_delete', function() {
        ...
        if (!confirm('是否確定要刪除?'))
          ...
          var direct = "deleteorder.php?id=" + data[0];
      ...
      $('tbody').on('click', '#btn_update', function() {
        var data = tbl.row($(this).closest('tr')).data();
        var direct = "order-detail.php?id=" + data[0];
        window.location.href = direct;
        ...
        <div class="page-content">
            <div class="container-fluid">
                        ...
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">訂單</a></li>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div>
                            <button type="button" class="btn btn-success waves-effect waves-light mb-3"><i class="mdi mdi-plus me-1"></i> 新增訂單</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <form name="form5" id="form5" method="post">
                        <table class="table table-hover tm-table-small tm-product-table" id="order">
                            <thead>
